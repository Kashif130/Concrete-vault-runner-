...
# ─── EXTRA CSS: flush iframe, kill all Streamlit padding ─────
st.markdown("""
<style>
html, body,
...
section.main > div { padding:0 !important; margin:0 !important; gap:0 !important; }
[data-testid="stToolbar"],[data-testid="stDecoration"],
[data-testid="stStatusWidget"],.stDeployButton { display:none !important; }
.game-frame { display:block; line-height:0; }
...
st.markdown(
    '<div class="game-frame" style="width:100%;height:100vh;overflow:hidden;">'
    f'<iframe src="data:text/html;base64,{game_b64}" '
    'style="width:100%;height:100vh;border:none;display:block;" '
    'allow="autoplay" scrolling="no"></iframe>'
    '</div>',
    unsafe_allow_html=True
)
